            ...
            >
              <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button className="px-4 py-2 bg-red-500 text-white font-semibold rounded-lg hover:bg-red-600 transition-all">
                    Reject
                  </button>
                  <button className="px-4 py-2 bg-yellow-500 text-dark font-semibold rounded-lg hover:bg-yellow-600 transition-all">
                    Revision
                  </button>
                </div>
              </div>
