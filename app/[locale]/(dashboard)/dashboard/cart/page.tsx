        ...
        <div className="space-y-4 sm:space-y-6 lg:space-y-0">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-2 mb-2">
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-gray-400 text-[10px] sm:text-xs lg:text-base">
                          {t('cart.validUntil', { date: item.validUntil })}
                        </p>
                      </div>
                      <button
                    ...
                    <div className="flex items-center justify-between mt-2 sm:mt-3">
                      ...
                      <div className="text-right">
                        ...
                        {item.quantity > 1 && (
                          <p className="text-gray-400 text-[10px] sm:text-xs lg:text-base">
                            {t('cart.krEach', { price: item.price.toLocaleString() })}
                          </p>
                        )}
                      </div>
                    </div>
              ...
              <div className="bg-card-background border border-primary rounded-2xl p-6 sticky top-6">
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <div className="border-t border-primary/30 pt-4">
                    <div className="flex items-center justify-between">
                      <span className="text-white font-bold text-lg">{t('cart.total')}</span>
          ...
          <div className="lg:hidden ">
            <div className="bg-card-background border border-primary rounded-2xl p-4">
              <h2 className="text-lg font-bold text-white mb-4">{t('cart.orderSummary')}</h2>
              ...
              <div className="space-y-3 mb-4">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-gray-400 text-sm">{t('cart.tax')}</span>
                  <span className="text-white font-semibold">
                    {tax.toLocaleString("en-US", {
                      minimumFractionDigits: 0,
                      maximumFractionDigits: 0,
