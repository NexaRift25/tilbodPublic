...
export default function HappyHourOfferCard({ offer }: HappyHourOfferCardProps) {
    const { title, time, description, image, status, location, pricing, availableDays, link } = offer;
            ...
            <div className="w-[25.625rem] h-[39.0625rem] relative overflow-hidden rounded-[1rem] border border-primary sm:rounded-[2.5rem] bg-card-background">
                ...
                <div className="relative h-[12.5rem] w-full bg-card-background sm:h-[15rem] border-b border-primary">
                    ...
                    <div className="absolute bottom-0 left-1/2 z-40 -translate-x-1/2 transform">
                        <div className={`whitespace-nowrap rounded-t-3xl text-xs shadow-lg px-[2rem] py-[0.34375rem] font-semibold lg:text-base border border-b-0 border-primary ${
